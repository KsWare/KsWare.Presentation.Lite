...
namespace KsWare.Presentation.Lite {
	...
	public class NotifyPropertyChangedBase : INotifyPropertyChanged {
		...
		/// <param name="fieldRef">A reference to the field to update.</param>
		/// <param name="newValue">The new value.</param>
		/// <param name="propertyName">The name of the property for change notifications.</param>
		/// <returns></returns>
		protected virtual bool Set<T>(ref T fieldRef, T newValue, [CallerMemberName] string propertyName = null) {
			if (EqualityComparer<T>.Default.Equals(fieldRef, newValue))  return false; 
			fieldRef = newValue;
